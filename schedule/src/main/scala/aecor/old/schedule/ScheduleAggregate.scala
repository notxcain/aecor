...
import aecor.old.aggregate._
import aecor.old.aggregate.serialization.{ PersistentDecoder, PersistentEncoder }
import aecor.old.data.Folded.syntax._
import aecor.old.data.{ Folded, Handler }
import aecor.old.schedule.ScheduleCommand.{ AddScheduleEntry, FireEntry }
import aecor.old.schedule.ScheduleEvent.{ ScheduleEntryAdded, ScheduleEntryFired }
import aecor.old.schedule.ScheduleState.ScheduleEntry
